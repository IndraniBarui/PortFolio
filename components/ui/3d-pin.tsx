    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start rounded-sm shadow-md border border-gray-300 border-solid group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
